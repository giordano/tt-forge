...
from third_party.tt_forge_models.vit.pytorch.loader import (
    ModelLoader as ViTLoader,
    ModelVariant as ViTVariant,
)
from .utils import (
...
def test_vit_torch_xla(
    ...
    model_variant = ViTVariant.BASE
    vit_loader = ViTLoader(model_variant)
    model_info = vit_loader.get_model_info(model_variant).name
...
def benchmark(config: dict):
    """
    Run the vit torch-xla benchmark.
